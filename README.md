...
cd SpaSNE
```
to access the downloaded folder. If the "git clone" command does not work with 
your computer, you can download the zip file from the website 
...
gmake
```
Please see the Makefile for other commands. If your computer does not have
