...
set up the above enviroment, please run the following command in the terminal to
...
gcc version 11.2.0. If your g++ version cannot successfully compile the code, 
please visit https://gcc.gnu.org/ to download the GCC 11.2. 

After you set up the environment, please refer to __Compilation__.
