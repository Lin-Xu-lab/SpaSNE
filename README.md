...
The annotation information for all the five datasets used in the paper are in 
the data_sources_and_annotations.xlsx file under the "data-annotation-info" 
folder. 
