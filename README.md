...
Note, if you do have the environment, the software package may also work for the
environment of your machine. That is why the __Compilation__ part is placed 
before __Environment setup__. You can use the two examples in __Examples__ for 
testing. Normally, both should be completed in a short time. However, if you 
find the code get stuck there, please follow the instructions in
