...
If you would like to import spasne in some other folders, there is an option to
make it work:
```
...
Then, you need to copy the "spasne" executable file generated by running "gmake"
in the terminal to the folder that the software is installed:
```
