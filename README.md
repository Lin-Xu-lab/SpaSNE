...
environment of your machine. That is why the __Compilation__ is placed before 
the __Environment setup__. You can use the two examples in __Examples__ for 
